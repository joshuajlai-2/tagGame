...
#ifndef TG_CONTROLLER_WANDER_H
#define TG_CONTROLLER_WANDER_H
...
namespace tagGame
{
   ...
   class tgControllerWander : public tgController
   {
   public:
      tgControllerWander(tgPerception* perception);
      virtual ~tgControllerWander();

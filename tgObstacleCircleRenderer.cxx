...
#include "tgObstacleCircleRenderer.h"
...
tgObstacleCircleRenderer::tgObstacleCircleRenderer(tgGameState* gs) :
   tgObjectRendererColor(gs)
{
}

tgObstacleCircleRenderer::~tgObstacleCircleRenderer()
{
}

void tgObstacleCircleRenderer::render(tgObject const* o)
{
   tgObjectRendererColor::render(o);

   tgRealVec const& p(o->getPosition());
   tgRealVec const& v(o->getOrientation());
   tgObstacleCircle const* obs(static_cast<tgObstacleCircle const*>(o));
   tgReal const r(obs->getRadius());

   tgGui::drawCircle(p, v, r);
}

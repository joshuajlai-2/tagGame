...
#ifndef TG_CONTROLLER_FLOCK_H
#define TG_CONTROLLER_FLOCK_H
...
namespace tagGame
{
   ...
   class tgControllerFlock : public tgController
   {
   public:
      tgControllerFlock(tgPerception* perception);
      virtual ~tgControllerFlock();

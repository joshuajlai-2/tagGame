...
tgControllerPeriodic::tgControllerPeriodic(tgPerception* perception,
                                           int const period,
...
tgControllerPeriodic::~tgControllerPeriodic()
{
}
...
// tgReal const slope(tgReal(maxFreq - minFreq)/(tagNear - tagFar));
// tgReal const intercept(tgReal(maxFreq) + tagNear * slope);
// int const freq(tgMath::clamp(tgMath::round(tagDist * slope + intercept), minFreq, maxFreq));

void tgControllerPeriodic::calcAction()
{

...
#ifndef TG_CONTROLLER_EVADE_H
#define TG_CONTROLLER_EVADE_H
...
namespace tagGame
{
   ...
   class tgControllerEvade : public tgController
   {
   public:
      tgControllerEvade(tgPerception* perception);
      virtual ~tgControllerEvade();

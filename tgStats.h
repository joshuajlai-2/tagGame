...
namespace tagGame
{
   ...
   /// Some useful functions on probability distributions.
   class tgStats
   {
   public:
      // Make v into a probability distribution (i.e. sum of the elements is 1)
      inline static tgRealVec& normalize(tgRealVec& v);
   protected:
   private:
   };
}

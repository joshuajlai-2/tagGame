...
#ifndef TG_CONTROLLER_PERIODIC_RAMP_H
#define TG_CONTROLLER_PERIODIC_RAMP_H
...
namespace tagGame
{
   ...
   class tgControllerPeriodicRamp : public tgController
   {
   public:
      tgControllerPeriodicRamp(tgPerception* perception,
                               ...
                               int const minPeriod,
                               int const maxPeriod);
      virtual ~tgControllerPeriodicRamp();

      void setMinPeriod(int const minPeriod);
      int getMinPeriod() const;

      void setMaxPeriod(int const maxPeriod);
      int getMaxPeriod() const;

      void setController(tgController* controller);
      tgController* getController() const;

      tgPerceptReal getDistance() const;
      tgReal getNearDistance() const;
      tgReal getFarDistance() const;

      void setDistance(tgPerceptReal const distance);
      void setNearDistance(tgReal const nearDistance);
      void setFarDistance(tgReal const farDistance);

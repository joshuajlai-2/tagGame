...
#include "tgTimerBase.h"

namespace tagGame
{
   /// Implements the platform specific part of the tgTimer class.
   class tgTimer : public tgTimerBase<tgTimer>
   {
   public:
      tgTimer();
      ~tgTimer();
      ...
      /// Wall clock time.
      /// To move the timer to a different platform simply re-implement this method.
      int time() const;

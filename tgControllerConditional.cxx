...
tgControllerConditional::tgControllerConditional(tgPerception* perception,
...
tgControllerConditional::~tgControllerConditional()
{
}

void tgControllerConditional::calcAction()
{
   ...
   TG_ASSERT(!((perception->*(condition))()));

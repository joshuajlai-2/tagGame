...
// <ai4Begin>tgControllerDecl</ai4Begin>
   ...
   public:
      ...
      inline tgAction const& getAction();
      /// Overide the last computed action.
      inline void setAction(tgAction const& action);
      /// Get a pointer to the current perception object.
      inline tgPerception* getPerception();
      ...
      inline void setPerception(tgPerception* perception);
   protected:
...
// <ai4End>tgControllerDecl</ai4End>

   tgAction const& tgController::getAction()
   {
      return this->action;
   }
   
   void tgController::setAction(tgAction const& action)
   {
      this->action = action;
   }
   
   tgPerception* tgController::getPerception()
   {
      return perception;
   }
   
   void tgController::setPerception(tgPerception* perception)
   {

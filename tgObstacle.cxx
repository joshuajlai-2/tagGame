...
tgObstacle::tgObstacle(tgGameState* gs) :
   tgObject(gs)
{
}

// TODO: inline this
bool tgObstacle::touching(tgObstacle const& o) const
{
   return distanceTo(o) <= tgReal(0);
}

bool tgObstacle::colliding(tgObstacle const& o) const
{
   tgRealVec const& v0(getVelocity());
   tgRealVec const& v1(o.getVelocity());
   tgRealVec const n(normalTo(o));

   return touching(o) && v0.dot(n) > v1.dot(n);
}

tgReal tgObstacle::distanceSquaredTo(tgObstacle const& o) const
{
...
ostream& tagGame::operator<<(ostream& out, tgObstacle const& o)
{
   return o.output(out);
}

...
#ifndef TG_CONTROLLER_AVOID_H
#define TG_CONTROLLER_AVOID_H
...
namespace tagGame
{
   ...
   class tgControllerAvoid : public tgController
   {
   public:
      tgControllerAvoid(tgPerception* perception, tgController* defaultController);
      virtual ~tgControllerAvoid();

      virtual void calcAction();

   protected:
   private:
      tgController* defaultController;
      int timeLastCollisionDetected;
   };
}

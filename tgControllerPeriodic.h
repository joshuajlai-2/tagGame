...
#ifndef TG_CONTROLLER_PERIODIC_H
#define TG_CONTROLLER_PERIODIC_H
...
namespace tagGame
{
   ...
   class tgControllerPeriodic : public tgController
   {
   public:
      tgControllerPeriodic(tgPerception* perception, int const period, tgController* controller);
      virtual ~tgControllerPeriodic();

      inline void setPeriod(int const period);
   ...
   void tgControllerPeriodic::setPeriod(int const period)
   {
      this->period = period;
   }
   
   int tgControllerPeriodic::getPeriod()
   {
      return period;
   }
   
   void tgControllerPeriodic::setController(tgController* controller)
   {
      this->controller = controller;
   }
   
   tgController* tgControllerPeriodic::getController()
   {
      return controller;
   }
}

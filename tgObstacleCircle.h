...
#ifndef TG_OBSTACLE_CIRCLE_H
#define TG_OBSTACLE_CIRCLE_H
...
namespace tagGame
{
   ...
   class tgObstacleCircle : public tgObstacle
   {
   public:
      tgObstacleCircle(tgGameState* gs);

      virtual ostream& output(ostream& out) const;

      inline tgReal getRadius() const;
      inline void setRadius(tgReal const radius);
   ...
   tgReal tgObstacleCircle::getRadius() const
   {
      return radius;
   }
   
   void tgObstacleCircle::setRadius(tgReal const radius)
   {
      this->radius = radius;
   }
}

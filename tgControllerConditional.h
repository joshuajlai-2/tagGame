...
#ifndef TG_CONTROLLER_CONDITIONAL_H
#define TG_CONTROLLER_CONDITIONAL_H
...
namespace tagGame
{
   ...
   class tgControllerConditional : public tgController
   {
   public:
      tgControllerConditional(tgPerception* perception, tgPerceptBool condition, tgController* controllerTrue, tgController* controllerFalse);
      virtual ~tgControllerConditional();

      inline tgPerceptBool getCondition();
      inline tgController* getControllerTrue();
      inline tgController* getControllerFalse();

      inline void setCondition(tgPerceptBool condition);
      inline void setControllerTrue(tgController* controllerTrue);
      inline void setControllerFalse(tgController* controllerFalse);

      virtual void calcAction();

   protected:
      tgPerceptBool condition;
      tgController* controllerTrue;
      tgController* controllerFalse;
   private:
   };

   void tgControllerConditional::setCondition(tgPerceptBool condition)
   {
      this->condition = condition;
   }
   
   tgPerceptBool tgControllerConditional::getCondition()
   {
      return condition;
   }
   
   void tgControllerConditional::setControllerTrue(tgController* controllerTrue)
   {
      this->controllerTrue = controllerTrue;
   }
   
   tgController* tgControllerConditional::getControllerTrue()
   {
      return controllerTrue;
   }
   
   void tgControllerConditional::setControllerFalse(tgController* controllerFalse)
   {
      this->controllerFalse= controllerFalse;
   }
   
   tgController* tgControllerConditional::getControllerFalse()
   {

...
tgControllerWander::tgControllerWander(tgPerception* perception) :
   tgController(perception)
{
}

tgControllerWander::~tgControllerWander()
{
}

void tgControllerWander::calcAction()
{
   action.setDesiredDirection(tgUtil2D::uniformDir());
   // Speed is clamped to at least 0.25 because slow movement is boring!
   action.setDesiredSpeed(tgMath::clamp(tgMath::uniform01(), 0.25, 1));
}

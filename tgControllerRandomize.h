...
#ifndef TG_CONTROLLER_RANDOMIZE_H
#define TG_CONTROLLER_RANDOMIZE_H
...
namespace tagGame
{
   ...
   class tgControllerRandomize : public tgController
   {
   public:
      tgControllerRandomize(tgPerception* perception,
                            tgController* controller,
                            tgPerceptReal distance,
                            tgReal near,
                            tgReal far);
      virtual ~tgControllerRandomize();

      // TODO: inline these
      tgController const* getController() const;

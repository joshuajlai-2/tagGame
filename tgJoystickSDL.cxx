...
tgJoystickSDL::tgJoystickSDL()
{
   SDL_Init(SDL_INIT_JOYSTICK);
}

bool tgJoystickSDL::init()
{
...
tgReal tgJoystickSDL::getX()
{
   //  Note: SDL_JoystickGetAxis returns a value in the range from -32768 to 32767.
   return SDL_JoystickGetAxis(joystick, 0) / tgReal(32768);
}

tgReal tgJoystickSDL::getY()
{
   //  Note: SDL_JoystickGetAxis returns a value in the range from -32768 to 32767.
   return -SDL_JoystickGetAxis(joystick, 1) / tgReal(32768);
}

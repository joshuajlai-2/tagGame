...
namespace tagGame
{
   ...
   {
   public:
      tgSimulator(tgGameState* gs);
      void forward(tgReal const deltaT);
   protected:
   private:
      void generateActions();
      void processActions(tgReal const deltaT);
      void updateCharacter(tgReal const deltaT, int const who);
      void resolveCollisions();
      void updateGameState(tgReal const deltaT);
      tgRealVec calcCollisionPenalty(int const who,
                                     tgRealVec const& f);

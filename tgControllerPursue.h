...
#ifndef TG_CONTROLLER_PURSUE_H
#define TG_CONTROLLER_PURSUE_H
...
namespace tagGame
{
   ...
   class tgControllerPursue : public tgController
   {
   public:
      tgControllerPursue(tgPerception* perception);
      virtual ~tgControllerPursue();

      virtual void calcAction();

   protected:
      tgCharacter* calcWhoToChase();
      void calcIsAngry();

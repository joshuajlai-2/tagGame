...
tgCharacter::tgCharacter(tgGameState* gs, tgController* controller) :
   tgObstacleCircle(gs),
...
void tgCharacter::calcAction()
{
   controller->calcAction();
   // Controller's can be shared to save this character's last computed action
   // in the class
   lastAction = controller->getAction();
}

void tgCharacter::setTagged(int tagTime)
{
...
tgAction const& tgCharacter::getAction() const
{
   return lastAction;
}

...
#include "tgControllerFlock.h"
#include "tgPerception.h"

using namespace tagGame;

tgControllerFlock::tgControllerFlock(tgPerception* perception) :
   tgController(perception)
{
}

tgControllerFlock::~tgControllerFlock()
{
}

void tgControllerFlock::calcAction()
{

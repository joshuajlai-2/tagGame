...
#ifndef TG_OBSTACLE_CIRCLE_RENDERER_H
#define TG_OBSTACLE_CIRCLE_RENDERER_H
...
namespace tagGame
{
   ...
   class tgObstacleCircleRenderer : public tgObjectRendererColor
   {
   public:
      tgObstacleCircleRenderer(tgGameState* gs);
      virtual ~tgObstacleCircleRenderer();

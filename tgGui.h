...
namespace tagGame
{
   ...
   public:
      ...
      static void createWindow(int const width, int const height, string const& title);
      static void destroyWindow();
      static void render(tgGameState* gs);
      static bool isQuit();

      static void drawCircle(tgRealVec const& center, tgRealVec const& orientation, tgReal const radius);
      static void drawArrow(tgRealVec const& begin, tgRealVec const& direction);
      static void drawLineSegment(tgRealVec const& begin, tgRealVec const& end);
      static void setColor(tgRealVec const& color);

      /// Pause for t milliseconds.
      static void pause(int const t);

      static tgRealVec const& getColorFromName(string const& colorName);
